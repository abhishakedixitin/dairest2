    ...
    <div class="x0" style="width:1300px">
      ...
      <h4 style="font-size: 15%vw">Registered Email Id:</h4>
          <input type="email" id="mail" name="user_email" style="border-color:rgb(110,65,30);border-width:thin" size="30" required><br>
                   <p> <a href= "forgotEmail.php" style="color:blue;margin-top:5%; font-size: 0.9vw;text-decoration: underline">Forgot Email Id?</a></p>
...
if (screen.width <= 699) {
location.replace("mobile-forgotUsername.php")
}
