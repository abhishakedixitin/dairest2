...
<html class="no-js" lang="en">
    ...
    <div class="x0" style="width:1300px">
      <div class="x2" style="width:700px; margin-left:200px;margin-right:100px">
          <form action="emailOTP.php" method="post" style="width:410px;height:250px; padding:13px">
        <h3 style="font-size: 50%vw; text-align:center">Get OTP on registered Mobile no. </h3><br><br>
 ...
 style="border-color:rgb(110,65,30);border-width:thin" size="30" required><br>
                   <p> <a href= "forgotMobile.php" style="color:blue;margin-top:5%; font-size: 0.9vw;text-decoration: underline">Forgot Mobile no.?</a></p>
...
if (screen.width <= 699) {
location.replace("mobile-forgotEmail.php")
}
