      ...
      <div class="x2" style="width:700px; margin-left:200px;margin-right:100px">
       ...
       <br><br> <h4 style="font-size: 15%vw">Password:</h4>
          ...
          <br> <h4 style="font-size: 15%vw">Mobile:</h4>
		        <input type="tel" pattern="\d{3}[\-]\d{3}[\-]\d{4}" id="mobile" name="user_mobile" style="border-color:rgb(110,65,30);border-width:thin" size="30" required title="Format: XXX-XXX-XXXX">    
<br><br>
